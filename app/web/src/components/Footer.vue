  ...
  <section>
    ...
    <div class="row at-row flex-center flex-middle">
      ...
      <div class="col-lg-12 credits">
        Azure Global Belt Team Changeddddsdsdsdddddddddfffffffdddddd
      </div>
      <div class="col-lg-6">
      </div>
    </div>
    <div class="row at-row flex-center flex-middle credits-tag">
      ...
      <div class="col-lg-12">
        <span class="credits">TEST IMAGE TAG:&nbsp;</span><span class="credits-black">{{imageTag}}</span>
      </div>
      <div class="col-lg-6">
      </div>
    </div>
    <div class="row at-row flex-center flex-middle">
      ...
      <div class="col-lg-12">
        <span class="credits"> TEST IMAGE BUILD DATE:&nbsp;</span><span class="credits-black">{{imageDate}}</span>
      </div>
      <div class="col-lg-6">
      </div>
    </div>
